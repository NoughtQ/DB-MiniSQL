...
// 初始化缓冲池并填充数据
void InitializeBufferPool(BufferPoolManager *bpm, std::vector<page_id_t> &page_ids, size_t buffer_pool_size,
                          size_t test_pages) {
...
// 测试页面替换
void TestPageReplacement(BufferPoolManager *bpm, const std::vector<page_id_t> &page_ids, size_t buffer_pool_size,
                         size_t test_pages) {
...
void TestRecentPages(BufferPoolManager *bpm, const std::vector<page_id_t> &page_ids, size_t buffer_pool_size,
                     size_t test_pages) {
