...
TEST(TableHeapTest, TableHeapDeleteTest) {
  ...
  for (int i = 0; i < 5; i++) {
    ...
    Fields *fields = new Fields{Field(TypeId::kTypeInt, i), Field(TypeId::kTypeChar, name, 4, true)};
    Row row(*fields);
    ASSERT_TRUE(table_heap->InsertTuple(row, nullptr));
...
TEST(TableHeapTest, TableHeapUpdateTest) {
  ...
  // 插入一条记录
  char *name = new char[4]{"abc"};
  Fields *fields = new Fields{Field(TypeId::kTypeInt, 1), Field(TypeId::kTypeChar, name, 4, true)};
  Row row(*fields);
  ASSERT_TRUE(table_heap->InsertTuple(row, nullptr));
  ...
  Fields *new_fields1 = new Fields{Field(TypeId::kTypeInt, 1), Field(TypeId::kTypeChar, new_name1, 4, true)};
  ...
  Fields *new_fields2 = new Fields{Field(TypeId::kTypeInt, 1), Field(TypeId::kTypeChar, new_name2, 64, true)};
...
TEST(TableHeapTest, TableHeapMassiveTest) {
  ...
  while (current_page_size < page_size_limit) {  // 留一些空间用于后续测试
    ...
    Fields *fields = new Fields{Field(TypeId::kTypeInt, row_id), Field(TypeId::kTypeChar, name1, len1, true),
                                Field(TypeId::kTypeFloat, RandomUtils::RandomFloat(-999.f, 999.f)),
  ...
  Fields *update_fields =
      new Fields{Field(TypeId::kTypeInt, row_id), Field(TypeId::kTypeChar, very_long_str, 64, true),
                 Field(TypeId::kTypeFloat, 999.f), Field(TypeId::kTypeChar, very_long_str, 128, true)};
  ...
  while (current_page_size < page_size_limit) {
    ...
    Fields *fields = new Fields{Field(TypeId::kTypeInt, row_id), Field(TypeId::kTypeChar, name1, 32, true),
                                Field(TypeId::kTypeFloat, RandomUtils::RandomFloat(-999.f, 999.f)),
  ...
  for (int i = 0; i < 10; i++) {
    ...
    Fields *fields = new Fields{Field(TypeId::kTypeInt, row_id + i), Field(TypeId::kTypeChar, name1, 32, true),
                                Field(TypeId::kTypeFloat, RandomUtils::RandomFloat(-999.f, 999.f)),
  ...
  for (int i = 0; i < 3; i++) {
    ...
    Fields *fields = new Fields{Field(TypeId::kTypeInt, row_id + 10 + i), Field(TypeId::kTypeChar, name1, 32, true),
                                Field(TypeId::kTypeFloat, RandomUtils::RandomFloat(-999.f, 999.f)),
                                Field(TypeId::kTypeChar, name2, 64, true)};
